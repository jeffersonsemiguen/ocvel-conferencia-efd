---
name: "source-command-core-readme-maker"
description: "Generate comprehensive, production-ready README.md by analyzing codebase with explorer + documenter agents"
---

# source-command-core-readme-maker

Use this skill when the user asks to run the migrated source command `core-readme-maker`.
