...
```bash
/design .Codex/sdd/features/DEFINE_CLOUD_RUN_FUNCTIONS.md
/design DEFINE_USER_AUTH.md
/design .Codex/sdd/features/DEFINE_INVOICE_EXTRACTION.md
```
...
Phase 2: /design     → .Codex/sdd/features/DESIGN_{FEATURE}.md (THIS COMMAND)
...
Read(.Codex/sdd/templates/DESIGN_TEMPLATE.md)
...
```markdown
Write(.Codex/sdd/features/DESIGN_{FEATURE_NAME}.md)
```
...
| Artifact | Location |
|----------|----------|
| **DESIGN** | `.Codex/sdd/features/DESIGN_{FEATURE_NAME}.md` |

**Next Step:** `/build .Codex/sdd/features/DESIGN_{FEATURE_NAME}.md`
...
- Agent: `.Codex/agents/workflow/design-agent.md`
- Template: `.Codex/sdd/templates/DESIGN_TEMPLATE.md`
- Contracts: `.Codex/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `.Codex/commands/workflow/build.md`
