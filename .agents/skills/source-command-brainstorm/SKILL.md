...
Use this skill when the user asks to run the migrated source command `brainstorm`.
...
```text
Phase 0: /brainstorm → .Codex/sdd/features/BRAINSTORM_{FEATURE}.md (THIS COMMAND)
...
Read(.Codex/sdd/templates/BRAINSTORM_TEMPLATE.md)
...
```markdown
Write(.Codex/sdd/features/BRAINSTORM_{FEATURE}.md)
```
...
| Artifact | Location |
|----------|----------|
| **Brainstorm Document** | `.Codex/sdd/features/BRAINSTORM_{FEATURE}.md` |

**Next Step:** `/define .Codex/sdd/features/BRAINSTORM_{FEATURE}.md`
...
- Agent: `.Codex/agents/workflow/brainstorm-agent.md`
- Template: `.Codex/sdd/templates/BRAINSTORM_TEMPLATE.md`
- Contracts: `.Codex/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `.Codex/commands/workflow/define.md`
