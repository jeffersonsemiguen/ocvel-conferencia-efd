---
name: "source-command-review-review"
description: "Dual AI code review with CodeRabbit + Codex"
---

# source-command-review-review

Use this skill when the user asks to run the migrated source command `review-review`.

## Command Template

# Review Command

> Dual AI code review with CodeRabbit + Codex for maximum coverage
...
/review --deep                 # Codex only (no CodeRabbit)
```
...
| **Codex** | Architectural review, business logic, GenAI patterns, contextual understanding |
...
### Step 3: Run Codex Deep Analysis
...
IF coderabbit command not found:
  ...
  2. If still fails: Proceed with Codex-only review
...
IF authentication error:
  ...
  2. Proceed with Codex-only review
...
Codex only — for thorough analysis:
...
**Process:**
1. Skip CodeRabbit
2. Full Codex analysis with all capabilities
...
- Agent: `.Codex/agents/code-quality/dual-reviewer.md`
- Config: `.coderabbit.yaml`
- Create PR: `.Codex/commands/workflow/create-pr.md`
