---
name: "source-command-knowledge-create-kb"
description: "Create a complete KB section from scratch with MCP validation"
---

# source-command-knowledge-create-kb

Use this skill when the user asks to run the migrated source command `knowledge-create-kb`.
