...
```bash
/build .Codex/sdd/features/DESIGN_CLOUD_RUN_FUNCTIONS.md
...
Phase 3: /build    → Code + .Codex/sdd/reports/BUILD_REPORT_{FEATURE}.md (THIS COMMAND)
...
```markdown
Write(.Codex/sdd/reports/BUILD_REPORT_{FEATURE}.md)
```
...
| **Build Report** | `.Codex/sdd/reports/BUILD_REPORT_{FEATURE}.md` |

**Next Step:** `/ship .Codex/sdd/features/DEFINE_{FEATURE}.md` (when ready)
...
- Agent: `.Codex/agents/workflow/build-agent.md`
- Template: `.Codex/sdd/templates/BUILD_REPORT_TEMPLATE.md`
- Contracts: `.Codex/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `.Codex/commands/workflow/ship.md`
