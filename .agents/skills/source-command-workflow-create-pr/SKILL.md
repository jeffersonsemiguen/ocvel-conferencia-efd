---
name: "source-command-workflow-create-pr"
description: "Automate professional pull request creation with conventional commits"
---

# source-command-workflow-create-pr
...
When using `--review`, the command runs a **dual AI review** (CodeRabbit + Codex) before creating the PR:
...
│          ↓                                                       │
│   3. Run Codex Review (architectural)                          │
│          ↓                                                       │
...
- Review Command: `.Codex/commands/review/review.md`
- Dual Reviewer Agent: `.Codex/agents/code-quality/dual-reviewer.md`
- CodeRabbit Config: `.coderabbit.yaml`
- Template: `.github/PULL_REQUEST_TEMPLATE.md`
- Workflow: `.Codex/sdd/_index.md`
- Agents: `.Codex/agents/workflow/`
