---
name: "source-command-workflow-iterate"
description: "Update any phase document when requirements or design changes"
---

# source-command-workflow-iterate

Use this skill when the user asks to run the migrated source command `workflow-iterate`.
...
/iterate .Codex/sdd/features/DEFINE_AUTH.md "Change from JWT to session-based auth"
```
...
- Agent: `.Codex/agents/workflow/iterate-agent.md`
