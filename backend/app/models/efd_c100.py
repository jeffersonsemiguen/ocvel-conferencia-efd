...
class EfdC100Doc(Base):
    __tablename__ = "efd_c100_docs"
    ...
    chv_nfe: Mapped[str | None] = mapped_column(String(44), nullable=True)
    dt_doc: Mapped[str | None] = mapped_column(String(8), nullable=True)
    dt_e_s: Mapped[str | None] = mapped_column(String(8), nullable=True)
    ...
    vl_frt: Mapped[float | None] = mapped_column(Numeric(15, 2), nullable=True)
    vl_seg: Mapped[float | None] = mapped_column(Numeric(15, 2), nullable=True)
    vl_out_da: Mapped[float | None] = mapped_column(Numeric(15, 2), nullable=True)
