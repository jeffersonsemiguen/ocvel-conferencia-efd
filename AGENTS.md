...
| `/sync-context` | Atualizar este AGENTS.md com estado atual |
| `/review` | Dual review: CodeRabbit + Codex |
...
- **Dúvida sobre layout EFD:** `/create-kb sped-fiscal-efd` ou consulte `.Codex/kb/sped-fiscal-efd/`
...
- **Agentes disponíveis:** `.Codex/agents/` (40 agentes organizados por categoria)
